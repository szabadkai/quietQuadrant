...
export const UPGRADE_BLUEPRINTS: UpgradeDefinition[] = [
  ...
  },
  {
    id: 'heavy-barrel',
    name: 'Heavy Barrel',
    description: '+25% projectile size, +20% damage, +5% crit damage, -10% fire rate.',
    rarity: 'common',
    category: 'offense',
    maxStacks: 3,
    dropWeight: 0.9,
  ...
  },
  {
    id: 'neutron-core',
    name: 'Neutron Core',
    description: 'Projectiles become heavy spheres that block enemy shots but move 40% slower.',
    rarity: 'legendary',
    category: 'defense',
    maxStacks: 1,
    dropWeight: 1,
  },
  {
    id: 'glass-cannon',
    name: 'Glass Cannon',
    description: 'Deal +200% Damage, +10% crit chance, but max HP is capped at 1.',
    rarity: 'legendary',
    category: 'offense',
    maxStacks: 1,
    dropWeight: 0.8,
  },
  {
    ...
    description: 'Projectiles allow no knockback, but PULL enemies into the impact point.',
    rarity: 'legendary',
    category: 'utility',
    maxStacks: 1,
    dropWeight: 1,
  ...
  },
  {
    id: 'blood-fuel',
    name: 'Blood Fuel',
    description: 'Killing enemies heals you. Firing weapons costs 2% of current HP.',
    rarity: 'rare',
    category: 'offense',
    maxStacks: 1,
    dropWeight: 0.5,
  },
  {
    ...
    description: 'Enemies explode on death for 50% of their max HP in a small radius.',
    rarity: 'rare',
    category: 'offense',
    maxStacks: 5,
    dropWeight: 0.8,
...
export const getUpgradeDefinition = (id: string) => UPGRADE_BLUEPRINTS.find((u) => u.id === id);
