...
describe("PlayerSystem", () => {
    ...
    describe("initialization", () => {
        ...
        test("creates player sprites and groups", () => {
            ...
            expect(mockScene.physics.add.image).toHaveBeenCalledWith(
                380,
                300,
                "player"
            );
        ...
        test("sets up input handling", () => {
            ...
            expect(
                mockScene.input.keyboard.createCursorKeys
            ).toHaveBeenCalled();
    ...
    describe("update loop", () => {
        ...
        test("update handles no active pilots gracefully", () => {
            ...
            (system as any).playerState = undefined;
...
describe("PlayerController", () => {
    ...
    describe("movement input processing", () => {
        ...
        test("processes keyboard movement input", () => {
            ...
            (playerController as any).wasd = mockWASD;
    ...
    describe("aiming input processing", () => {
        ...
        test("processes mouse aiming input", () => {
            ...
            (mockScene.input as any).activePointer = { x: 500, y: 300 };
            (mockScene.cameras.main as any).getWorldPoint = jest.fn(() => ({
                x: 500,
                y: 300,
            }));
