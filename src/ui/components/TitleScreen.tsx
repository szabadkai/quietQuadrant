  ...
  return (
    <div className="overlay title-screen">
      <div className="panel hero">
        ...
        <p>
          Minimalist roguelike shooter in a contained arena. Build a sharp loadout, weave through
          escalating waves, and survive the bullet-hell boss.
        </p>
        ...
        <br></br>
        <div className="note">
          Twin Mode now flies two ships at once. Pick who is on keyboard/mouse or which controller
          each pilot uses before launching.
        </div>
        <div className="note">
          ...
          <div className="season-card">
            ...
            <div className="season-row">
              ...
              {seasonInfo.boss && (
                <span className="pill">
                  Boss:{' '}
                  {BOSSES.find((b) => b.id === seasonInfo.boss?.id)?.name ?? seasonInfo.boss.name}
                </span>
              )}
              {seasonInfo.affix && (
                <span className="pill">
