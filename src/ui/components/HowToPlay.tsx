			...
			<div className="panel">
				...
				<div className="info-grid">
					...
					<div>
						...
						<div className="desc">
							Clear waves, collect XP, pick 1 of 3 upgrades
						</div>
					</div>
					<div>
						<div className="label">Controller</div>
						<div className="desc">
							Left Stick to move · Right Stick aims & auto-fires · LB/LT to dash
							· Start pauses. Twin Mode supports two controllers or one keyboard
							plus a controller.
						</div>
					</div>
				</div>
				<p className="note">
					Runs are 10–15 waves capped by a bullet-hell boss. Upgrades stack;
					rare picks create spikes in power. Stay light on your feet and watch
					projectile patterns.
				</p>
