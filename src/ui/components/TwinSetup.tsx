	...
	return (
		<div className="overlay info-screen twin-setup">
			<div className="panel">
				...
				<p className="note">
					Pick who flies on keyboard/mouse versus which controller. Each pilot
					gets their own ship, but upgrades are shared. Devices can&apos;t be
						...
						<div className="option-list">
							{options.map((opt) => (
								...
								>
									...
									{isTakenByOther(opt, "p1") && (
										<span className="tiny">Taken</span>
									)}
								</button>
							))}
						</div>
						...
						<div className="option-list">
							...
							{options.length === 1 && (
								<div className="tiny muted">
									Plug in a second controller to start co-op.
								</div>
							)}
						</div>
					</div>
