...
export const UPGRADE_BLUEPRINTS: UpgradeDefinition[] = [
    ...
    },
    {
        ...
        name: "Momentum Feed",
        description:
            "Moving builds up to +25% fire rate over sustained motion.",
        rarity: "rare",
        category: "utility",
        maxStacks: 2,
        dropWeight: 0.9,
    ...
    },
    {
        ...
        description:
            "Projectiles travel through walls and obstacles effortlessly.",
        rarity: "rare",
        category: "utility",
        maxStacks: 1,
        dropWeight: 0.6,
    },
    {
        ...
        name: "Berserk Module",
        description:
            "The lower your health, the faster you fire (up to +100%).",
        rarity: "rare",
        category: "offense",
        maxStacks: 3,
        dropWeight: 0.9,
